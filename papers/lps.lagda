...
working on a fragment of Intuitionistic Linear
Logic~\cite{girard1987linear} (ILL onwards), the sort
...
consuming a resource \AIC{κ} \AB{k} from a context \AB{Γ} with leftovers
\AB{Δ}, then the axiom rule\footnote{In this presentation,
...
This whole section is parametrised by a commutative monoid \AB{Mon}
(as defined in the file \file{Algebra} of Agda's standard
